            ...
            <div className="text-content">
                <div className="fingertips-container" data-test-id="fingertips-container" data-impression-item="1e64c694-ff65-4bb7-be1d-724cc537fd36" impressed-item="true">
                    ...
                    <div className="fingertips-cta">
                        <a className="btn-signup" onClick={() => openModal(true)}>Join now</a>
                    </div>
                </div>
                <ul className="benefits-list">
                    ...
                    <li>Discover a world of top freelance talent, explore diverse skills at your fingertips</li>
                    <li>Get results from experienced freelancers worldwide for any task, at any price</li>
                    <li>Pay per project or by the hour. Funds are released only when you approve the work</li>
                    <li>Quickly filter to find the perfect freelancers and get high-quality work on time</li>
                </ul>
            </div>
            <div className="advert-area">
                <video
                    style={{ width: '100%', maxWidth: '1048px', height: '590px', borderRadius: '15px' }}
