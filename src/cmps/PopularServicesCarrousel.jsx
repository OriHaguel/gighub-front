	...
	return (
		<div className='popular-carrousel-grid'>
			...
			<div className='popular-services-carrousel'>
				<Carousel showThumbs={false} showStatus={false} showIndicators={false} showArrows={false} centerMode={true} centerSlidePercentage={16} selectedItem={currentIndex} onChange={index => setCurrentIndex(index)}>
